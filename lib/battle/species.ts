...
export const SPECIES_MOVES = {
  ...
  swift: m({ id: 'swift', nameZh: '高速星星', nameEn: 'Swift', type: 'normal', power: 60, cooldownMs: 2500, kind: 'projectile', speed: 16, range: 25, color: '#ffd75e' }),
  ...
  aeroblast: m({ id: 'aeroblast', nameZh: '氣旋攻擊', nameEn: 'Aeroblast', type: 'flying', power: 100, cooldownMs: 5500, kind: 'projectile', speed: 13, range: 25, color: '#bfe8ff' }),
  ...
  dragonPulse: m({ id: 'dragonPulse', nameZh: '龍之波動', nameEn: 'Dragon Pulse', type: 'dragon', power: 85, cooldownMs: 4500, kind: 'projectile', speed: 12, range: 25, color: '#54e0c0' }),
  ...
  auraSphere: m({ id: 'auraSphere', nameZh: '波導彈', nameEn: 'Aura Sphere', type: 'fighting', power: 80, cooldownMs: 3500, kind: 'projectile', speed: 13, range: 25, color: '#4aa3ff' }),
  blueFlare: m({ id: 'blueFlare', nameZh: '青焰', nameEn: 'Blue Flare', type: 'fire', power: 130, cooldownMs: 6500, kind: 'projectile', speed: 11, range: 25, color: '#6ec8ff' }),
  ...
  waterShuriken: m({ id: 'waterShuriken', nameZh: '水手裏劍', nameEn: 'Water Shuriken', type: 'water', power: 60, cooldownMs: 2200, kind: 'projectile', speed: 18, range: 25, color: '#5ad0ff' }),
  ironHead: m({ id: 'ironHead', nameZh: '鐵頭功', nameEn: 'Iron Head', type: 'steel', power: 80, cooldownMs: 2200, kind: 'melee', range: 2.8, color: '#cdd6e8' }),
  psychicBlast: m({ id: 'psychicBlast', nameZh: '精神強念', nameEn: 'Psychic', type: 'psychic', power: 90, cooldownMs: 4500, kind: 'projectile', speed: 12, range: 25, color: '#e08aff' }),
  ...
  moonblast: m({ id: 'moonblast', nameZh: '月亮之力', nameEn: 'Moonblast', type: 'fairy', power: 95, cooldownMs: 4500, kind: 'projectile', speed: 12, range: 25, color: '#ffb3d9' }),
